...
export function state_resize(a: number, b: number, c: number): void;
export function state_mouse_moved(a: number, b: number, c: number): void;
...
export function _dyn_core__ops__function__FnMut__A____Output___R_as_wasm_bindgen__closure__WasmClosure___describe__invoke__h11eddb4274bc91e6(a: number, b: number, c: number): void;
export function _dyn_core__ops__function__FnMut_____Output___R_as_wasm_bindgen__closure__WasmClosure___describe__invoke__h30063b4d60c90814(a: number, b: number): void;
export function _dyn_core__ops__function__FnMut__A____Output___R_as_wasm_bindgen__closure__WasmClosure___describe__invoke__h4c0ba75e7af5928a(a: number, b: number, c: number): void;
